...
public class TravelScheduleController {
    ...
    */
	...
	public List<TravelScheduleDTO> searchSchedules(@Valid TravelScheduleDTO searchDTO,
	    ...
	    Page<TravelSchedule> schedules = scheduleRepository.findByCriteria(
	            searchDTO.getSource(),
	            ...
	            pageable);
	    List<TravelScheduleDTO> scheduleDTOs = schedules.stream()
	    		.map(schedule -> new TravelScheduleDTO(schedule)).collect(Collectors.toList());
	    return scheduleDTOs;
	}
